...
ապա բառային վերլուծիչը կարդում է նիշերի հետևյալ շարքը. «`L`», «`E`», «`T`», «`␣`», «`n`», «`a`», «`m`», «`e`», «`$`», «`␣`», «`=`», «`␣`», «`"`», «`N`», «`a`», «`m`», «`e`», «`:`», «`␣`», «`"`»։ Այնուհետև դրանցից կազմում է BASIC-IR լեզվի `LET`, `name$`, `=` և `Name: ` բառային միավորները։ 
...
| :------: | :-----------------: | :-----------------------: |
| `LET`    | `Token::Let`        | `LET` ծառայողական բառը   |
| `name$`  | `Token::Identifier` | իդենտիֆիկատոր           |
| `=`      | `Token::Eq`         | վերագրման նշան          |
| `Name:␣` | `Token::TextLit`   | տեքստային լիտերալ       |
